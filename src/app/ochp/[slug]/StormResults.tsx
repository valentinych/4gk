          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border text-xs text-muted uppercase tracking-wider">
                <th className="px-2 py-2.5 text-right font-medium w-8 sticky left-0 bg-surface z-10">
                  №
                </th>
                <th className="px-2 py-2.5 text-left font-medium sticky left-8 bg-surface z-10">
                  Команда
                </th>
            ...
            <tbody className="divide-y divide-border">
              {data.teams.map((team, i) => (
                <tr key={i} className="hover:bg-surface/50">
                  <td className="px-2 py-1.5 text-right text-muted font-mono text-xs sticky left-0 bg-surface z-10">
                    {i + 1}
                  </td>
                  <td className="px-2 py-1.5 sticky left-8 bg-surface z-10">
